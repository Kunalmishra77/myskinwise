...
export const DICTIONARY = {
  ...
  "voice.persona": { en: "Dr. Vivek", hi: "डॉ. विवेक" },
  "voice.personaTag": { en: "Your personal skincare expert", hi: "आपका पर्सनल स्किनकेयर एक्सपर्ट" },
  "voice.tapToSpeak": { en: "Tap to speak", hi: "बोलने के लिए टैप करें" },
  "voice.tapToTalk": { en: "Tap to talk to Dr. Vivek", hi: "डॉ. विवेक से बात करने के लिए टैप करें" },
  "voice.listening": { en: "Listening…", hi: "सुन रहा हूँ…" },
  "voice.gotIt": { en: "Got it…", hi: "समझ गया…" },
  "voice.thinking": { en: "Thinking…", hi: "सोच रहा हूँ…" },
  "voice.speaking": { en: "Speaking… just talk to interrupt", hi: "बोल रहा हूँ… रोकने के लिए बस बोलें" },
  ...
  "voice.emptyHint": {
    en: "Tap the circle — Dr. Vivek will say hi, then bas baat karo: koi concern, ingredient, routine, kuch bhi.",
    hi: "गोले पर टैप करें, डॉ. विवेक हाय कहेंगे, फिर बस बात करें — किसी concern, ingredient, routine, कुछ भी के बारे में।",
  },
  "voice.intro": {
    en: "Tap the mic and ask anything about your skin — main bolke jawab dunga, aur sunta rahunga taaki aap bas baat karte raho.",
    hi: "माइक पर टैप करें और अपनी स्किन के बारे में कुछ भी पूछें — मैं बोलकर जवाब दूँगा, और सुनता रहूँगा ताकि आप बस बात करते रहें।",
  },
