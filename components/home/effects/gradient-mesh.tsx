 ...
 * `motion-safe:animate-drift-*` so under `prefers-reduced-motion:
 * reduce` the blobs render fully static with no JS involved at all.
 */
export function GradientMesh({ className }: GradientMeshProps) {
  return (
    <div aria-hidden="true" className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      <div className="absolute -left-24 -top-24 size-[26rem] rounded-full bg-rose/25 blur-[100px] motion-safe:animate-drift-a" />
      <div className="absolute -right-20 top-1/4 size-[24rem] rounded-full bg-champagne/60 blur-[110px] motion-safe:animate-drift-b" />
      ...
      <div className="absolute bottom-[-6rem] left-1/3 size-[22rem] rounded-full bg-[#E7D6F0]/45 blur-[100px] motion-safe:animate-drift-a" />
    </div>
  );
}
